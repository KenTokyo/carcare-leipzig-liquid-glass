...
export const faqsByRoute: Record<string, FAQItem[]> = {
  ...
  '/ueber-uns': [
    { id: 'wer', question: 'Wer steht hinter dem CarCare Center Leipzig?', answer: 'Betreiber ist die BS CarCare GmbH mit Sitz An den Tierkliniken 42, 04103 Leipzig. Wir bestehen seit 1998, sind Meisterbetrieb im Kfz-Lackier- und Karosseriebauhandwerk und beschäftigen über 50 Mitarbeiter auf über 3.000 m² Betriebsfläche.' },
