...
import { AUFPREIS_SATZ } from './detailing';
...
export const faqsByRoute: Record<string, FAQItem[]> = {
  ...
  '/leistungen': [
    ...
    { id: 'einhaus', question: 'Bekomme ich Reparatur und Lackierung aus einer Hand?', answer: 'Ja. Karosseriearbeiten, Lackierung, Smart Repair, Felgen und Aufbereitung finden auf über 3.500 m² im eigenen Haus statt. Ihr Fahrzeug wird für die einzelnen Schritte nicht an Fremdbetriebe weitergereicht.' },
  ...
  '/unfallinstandsetzung-leipzig': [
    { id: 'melden', question: 'Wie melde ich einen Unfallschaden beim CarCare Center Leipzig?', answer: 'Sie können den Schaden telefonisch unter 0341 - 261 77 90 oder online über unsere Schadenseite auf reparatur.info melden. Dort laden Sie Schadendaten und Fotos hoch oder vereinbaren direkt einen Besichtigungstermin. Hilfreich sind Fahrzeugdaten, Schadenart, Fotos des Schadens und Informationen zur Versicherung.' },
    ...
    { id: 'marken', question: 'Repariert das CarCare Center auch mein Fahrzeugfabrikat?', answer: 'Ja. Wir sind ein markenunabhängiger Meisterbetrieb im Kfz-Lackier- und Karosseriebauhandwerk und bearbeiten alle Marken – vom Kleinwagen bis zum Premiumfahrzeug.' },
  ],
  ...
  '/fahrzeugaufbereitung-leipzig': [
    ...
    { id: 'preise', question: 'Was kostet eine Autoaufbereitung beim CarCare Center Leipzig?', answer: `Die Brillant Außenpflege kostet 169,00 €, die Intensiv Innenraumreinigung 199,00 € und die Premiumpflege als Kombination beider Pakete 299,00 €. ${AUFPREIS_SATZ} Die Premiumpflege „exklusiv“ mit Swissvax-Wachsen hat keinen Festpreis — den Preis stimmen wir persönlich mit Ihnen ab. Die Lackaufbereitung berechnen wir nach Aufwand. Alle Preise verstehen sich inklusive gesetzlicher Mehrwertsteuer.` },
    { id: 'paketwahl', question: 'Welches Pflegepaket ist das richtige für mich?', answer: 'Geht es um Glanz und Lackschutz von außen, reicht die Brillant Außenpflege. Steht der Innenraum im Vordergrund – etwa Polster, Leder oder Gerüche –, ist die Intensiv Innenraumreinigung passend. Wer beides braucht, etwa vor Verkauf oder Leasingrückgabe, wählt die Premiumpflege.' },
  ...
  '/privatkunden': [
    ...
    { id: 'kosten', question: 'Was kostet die Aufbereitung meines Autos?', answer: `Die Brillant Außenpflege kostet 169,00 €, die Intensiv Innenraumreinigung 199,00 € und die Premiumpflege als Kombination beider 299,00 €. ${AUFPREIS_SATZ} Die Premiumpflege „exklusiv“ hat keinen Festpreis, den Preis stimmen wir persönlich mit Ihnen ab. Alle Preise inklusive gesetzlicher Mehrwertsteuer. Für Reparaturen erhalten Sie einen individuellen Kostenvoranschlag, weil der Aufwand vom Schadenbild abhängt.` },
  ...
  '/geschaeftskunden': [
    ...
    { id: 'schadensteuerung', question: 'Arbeitet das CarCare Center mit Versicherungen und Schadensteuerern zusammen?', answer: 'Ja. Versicherer und Schadensteuerer — etwa riparo — gehören zu unseren Geschäftskunden. Wir übernehmen Schadenaufnahme, Kalkulation über das anerkannte System Audatex und die Instandsetzung aus einer Hand — inklusive Schriftverkehr und Abstimmung mit dem Gutachter.' },
    ...
    { id: 'flotte', question: 'Können mehrere Fahrzeuge gleichzeitig bearbeitet werden?', answer: 'Ja. Auf über 3.500 m² mit über 50 Mitarbeitern lassen sich auch mehrere Fahrzeuge parallel bearbeiten — etwa bei Hagelereignissen oder wiederkehrender Flottenpflege. Umfang und Zeitfenster werden vorab abgestimmt.' },
    ...
    // id bis 2026-09-16 'digital' — doppelt mit dem Eintrag oben. `PageFAQ` nutzt die id als
    // React-`key`: zwei gleiche keys (React warnt, und beim Neurendern kann es die Eintraege
    // verwechseln). Ein Akkordeon (`FAQSection`, oeffnet nach id) haette beide zugleich geoeffnet.
    { id: 'schadenuebermittlung', question: 'Gibt es digitale Schadenübermittlung?', answer: 'Ja. Schäden lassen sich über unsere Schadenseite auf reparatur.info digital übermitteln — mit Schadendaten und Fotos. Daneben erreichen Sie uns telefonisch und per E-Mail. Die weitere Abwicklung läuft über unser Programm Data Motive.' },
  ],
  ...
  '/leasingrueckgabe-leipzig': [
    ...
    { id: 'kosten', question: 'Was kostet die Vorbereitung auf die Leasingrückgabe?', answer: `Für die Reparaturen gibt es keinen Listenpreis, weil der Aufwand vom Schadenbild abhängt — Sie erhalten dafür einen Kostenvoranschlag. Für die Aufbereitung gelten feste Preise: Intensiv Innenraumreinigung 199,00 €, Premiumpflege mit Innen- und Außenaufbereitung 299,00 €, jeweils inklusive gesetzlicher Mehrwertsteuer. ${AUFPREIS_SATZ}` },
  ...
  '/ueber-uns': [
    { id: 'wer', question: 'Wer steht hinter dem CarCare Center Leipzig?', answer: 'Betreiber ist die BS CarCare GmbH mit Sitz An den Tierkliniken 42, 04103 Leipzig. Wir bestehen seit 1998, sind Meisterbetrieb im Kfz-Lackier- und Karosseriebauhandwerk und beschäftigen über 50 Mitarbeiter auf über 3.500 m² Betriebsfläche.' },
    { id: 'groesse', question: 'Wie groß ist der Betrieb?', answer: 'Wir gehören mit über 3.500 m² Betriebsfläche und über 50 Mitarbeitern zu den größten Karosserie- und Lackierbetrieben in Leipzig und Umgebung. Die Größe erlaubt es uns, mehrere Fahrzeuge parallel zu bearbeiten und Karosserie, Lack, Smart Repair, Felgen, Glas und Aufbereitung vollständig im eigenen Haus abzudecken.' },
  ...
  '/aussenaufbereitung-leipzig': [
    { id: 'umfang', question: 'Was gehört zur Außenaufbereitung?', answer: `Intensive Vorreinigung und Felgenreinigung, Insektenentfernung, schonende Handoberwäsche und Scheibenreinigung. Zusammen mit Hochglanzpolitur und Lackversiegelung kostet dieser Umfang als Brillant Außenpflege 169,00 € inklusive gesetzlicher Mehrwertsteuer. ${AUFPREIS_SATZ}` },
  ...
  '/innenaufbereitung-leipzig': [
    { id: 'umfang', question: 'Was gehört zur Innenaufbereitung?', answer: `Intensive Reinigung des gesamten Innenraumes inklusive Cockpit und Oberflächen, Polstershampoonierung oder materialgerechte Lederpflege, Teppichreinigung, Scheibenreinigung innen und außen sowie auf Wunsch Geruchsentfernung. Als Intensiv Innenraumreinigung kostet dieser Umfang 199,00 € inklusive gesetzlicher Mehrwertsteuer. ${AUFPREIS_SATZ}` },
    ...
    { id: 'motorreinigung', question: 'Ist die Motorreinigung enthalten?', answer: 'Nicht in der Intensiv Innenraumreinigung. Sie ist Teil der Premiumpflege für 299,00 €, die Innen- und Außenaufbereitung kombiniert.' },
