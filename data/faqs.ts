...
export const faqsByRoute: Record<string, FAQItem[]> = {
  ...
  '/aussenaufbereitung-leipzig': [
    { id: 'umfang', question: 'Was gehört zur Außenaufbereitung?', answer: 'Intensive Vorreinigung und Felgenreinigung, Insektenentfernung, schonende Handoberwäsche, Lackreinigung und Scheibenreinigung. Als Brillant Außenpflege kostet dieser Umfang 169,00 € inklusive gesetzlicher Mehrwertsteuer.' },
