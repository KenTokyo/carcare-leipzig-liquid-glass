...
export const serviceCatalog: ServiceCatalogEntry[] = [
  {
    ...
    description: 'Innen, außen, Lackpflege und Pflegepakete für sichtbaren Werterhalt.',
    listDescription: 'Innen- und Außenaufbereitung, Lackreinigung, Politur und Versiegelung — für Alltag, Verkauf und Werterhalt.',
    iconName: 'Sparkles',
