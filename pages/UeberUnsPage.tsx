 ...
 *
 * Foto, Alternativtext und Bildmasse kommen ueber `LeistungsKarten` aus
 * `data/services.ts` — hier steht nur, WELCHE Bereiche gezeigt werden und wie sie auf
    ...
    <section id="leistungsspektrum" className="bg-gray-50/70 px-6 py-20 md:py-28">
      <div className="container mx-auto">
        ...
        {/* Dieselbe Kartenform wie die Aufbereitungsbereiche auf
            `/fahrzeugaufbereitung-leipzig` — seit 2026-09-07 als geteilte Komponente,
            damit sie nicht je Seite kopiert wird. `FeatureGrid` bleibt auf dieser Seite
            fuer Zahlen, Qualifikationen, Kunden und Arbeitgeber in Gebrauch. */}
        <LeistungsKarten items={spectrum} />
      </div>
    </section>
