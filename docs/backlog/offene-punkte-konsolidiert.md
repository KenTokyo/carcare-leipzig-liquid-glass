...
**Stand:** 2026-09-06, gegen den Code nachgezogen am **2026-09-07**; **2026-09-25** (Schleife 5 aus dem Meeting mit André — `docs/backlog/schleife-5.md`); **2026-09-23** (R18 erledigt — `docs/betriebsvideo/tasks/2026-09-23-bereichsvideos-tasks.md`); **2026-09-14** (2.1, 2.3, 4.2, 4.18 erledigt — `docs/schleife-2-4-karten-ablauf-flaeche/`); **2026-09-16** (Kundenentscheidungen: R13 erledigt, R12 ruht, R9 für Schäden gelöst, Partnerlogos teilweise — `docs/preise-partner-schadenlink/`); **2026-09-17** (R14 erledigt — `docs/zielgruppen-partner-sichtbarkeit/`; danach Abgleich nach dem Pull, mit Gesamtliste — `docs/backlog/tasks/2026-09-17-abgleich-offene-punkte-tasks.md`); **2026-09-21** (Fotolieferung eingebaut: R2, R16, 3.8 und sieben weitere Fotopunkte erledigt, R17 und R18 neu — `docs/bilder/tasks/2026-09-21-bildtausch-lieferung-september-tasks.md`); Abschnitt 1 und 3 am
...
> **Neu: Schleife 5** (Meeting mit André, 2026-09-25) — 44 Punkte in `docs/backlog/schleife-5.md`, dort geführt.
> Übernommen wird hier nur, was Schleife 5 an Punkten dieser Datei ändert: R1 (letztes Jahr), R4, R5 (Telefon),
> R9 (Bewerbung), R10 (Empfänger), R15 (neun Dateien), Partnerlogos (VW, Audi); **1.18/2.26** und der
> Stimmen-Teil von **1.26** sind in Schleife 5 aufgegangen. ⚠️ **Livegang in KW 40 geplant — R5 und R6
> wurden im Meeting nicht besprochen.**
...
>
> **Fotos (2026-09-21):** Lieferung „Neue Fotos Schleife September“ eingebaut — 11 Fotos und ein
> Lackiervideo, je B-Nummer nach Vorgabe des Users (`docs/bilder/tasks/2026-09-21-bildtausch-lieferung-september-tasks.md`).
> Erledigt damit **2.14, 2.15/3.29, 2.16, 2.20, 2.21/3.4, 3.8, 3.11/3.24, 3.26** und **R2**. Neu: **R18**.
...
| **R3** | Inhalt | **Erklärtexte für sieben Leistungsseiten**, je 2–3 Absätze „Was ist X?" | André | blockiert **1.15** — die Sektion steht auf sieben Seiten und ist leer | offen · im Meeting 2026-09-25 nicht besprochen |
| **R1** | Inhalt | **Meilensteine für den Zeitstrahl:** Jahr + ein Satz je Station | André | ~~drei Platzhalter~~ noch **einer** auf `/ueber-uns` | ✅ **geliefert 2026-09-10** (4.16–4.20). Eingebaut: 1998, 2000, 2026 am 2026-09-11; **2013 am 2026-09-14**, entsperrt durch die Flächenentscheidung 4.2. **5 von 6 Stationen stehen.** Offen nur noch das **Jahr für Meilenstein 3** (4.19) · **2026-09-25: Jahr geliefert** — 2017, „Eintritt in die Schadensteuerung" (5.24) |
| **1.18** = **2.26** | Inhalt | ~~**Liste der Zusatzleistungen** fürs Aufbereitungsformular. Dabei klären: Was ist Paket, was Zusatz~~ | André | zwei Platzhalter im Formular | 🔁 **in 5.20 aufgegangen** — Teilliste 2026-09-25 (Geruchsneutralisierung / Ozon / Heißvernebelung / Desinfektion, Cabrio-Verdeckimprägnierung, Motorreinigung); die vollständige Liste schreibt André auf |
| **R4** | Inhalt | **Ausbildung bestätigen** (wird im kommenden Jahrgang ausgebildet?) plus je Beruf Beginn, Dauer, Voraussetzungen, Übernahmechancen | André | — | 🟨 **bestätigt 2026-09-25** — Ausbildung aktiv, Karosserie und Lack ab Sommer 2027, Industriekaufmann/-frau ohne Hinweis (5.26); offen nur noch die Eckdaten je Beruf |
...
| **1.26** | Inhalt | **Benefits + Mitarbeiterstimmen** für die Karriereseite | André | bündeln mit R4 | offen · Mitarbeiterstimmen → 🔁 5.28 (neu: Foto optional); **Benefits** weiter offen |
| **R7** | Bild | **Echtes Vorschaubild statt Unsplash-Stockfoto** (`og:image`, JSON-LD). *Deckungsgleich mit dem offenen OG-Bild-Punkt im Preloader-Plan* | André | — | offen · im Meeting 2026-09-25 nicht besprochen |
| **R2** | Bild | **Eigene Motive** für Leasingrückgabe und Außenaufbereitung | André | beide teilen sich ein Bild mit anderen Kacheln | ✅ **erledigt 2026-09-21** — „Leasingrückgabe vorbereiten“ (B29) und Außenaufbereitung (B28 Startseite, B46 Aufbereitungsseite, B66 Seitenhintergrund) zeigen eigene, echte Fotos. Offen nur als Gestaltungsfrage: B46 und B47 stehen nebeneinander mit demselben Politurfoto |
| **R15** | Bild / Recht | **Herkunft jedes Fotos bestätigen:** echtes Foto · KI-bearbeitet · KI-generiert. Seit 02.08.2026 gilt die Kennzeichnungspflicht aus Art. 50 KI-VO; dokumentiert ist die Herkunft für kein Foto (Backlog nennt selbst ein „KI-Bild“, 2.15). Liste mit festen Nummern und Motiven: `docs/bilder/README.md` | André *(und OALAB, falls selbst erzeugt)* | vor dem Livegang: je Bild ersetzen oder kennzeichnen | offen, aufgenommen 2026-09-18 (Bildinventar) · **2026-09-21:** Kennzeichnung am Bild steht („KI-generiert“ als Vorgabe); die 11 Fotos und das Lackiervideo der neuen Lieferung sind vom User als **echt** bestätigt (`data/bildherkunft.ts`, Metadaten `digitalCapture`). Offen: welche der übrigen Motive nur aufgewertet sind · **2026-09-25 (Meeting):** 4 Dateien echt, 2 KI-bearbeitet, 3 KI-generiert bestätigt → 5.9; offen: Startbild/Footer, `kalkulation`, `versicherungsabwicklung`, `versicherungen-und-agenturen`, `wissensdatenbank`; Plakette dezenter → 5.3 |
| **R16** | Bild / Recht | **Karriere-Video (B110/B111):** Das Kennzeichen eines Kundenfahrzeugs ist im Standbild und im Clip (etwa Sekunde 22–26) lesbar; unkenntlich machen in `npm run video`. Dazu zeigen das Karriere- und das Rundgang-Video (B101/B102) **erkennbar Mitarbeitende**: liegt deren schriftliche Einwilligung vor (§ 22 KUG)? Im Über-uns-Video sind Personen nur klein im Hintergrund. Geprüft an Einzelbildern im Abstand von 1,5–2,5 s, nicht Bild für Bild | OALAB *(Kennzeichen)* · André *(Einwilligungen)* | — | ✅ **erledigt 2026-09-21** — Einwilligung der Mitarbeitenden liegt laut User vollumfänglich vor; damit umgesetzt: bewegte Weichzeichnung in `npm run video`, Bild für Bild am fertigen Video kontrolliert. **Nachgeprüft statt übernommen:** Im Karriere-Video waren es vier Stellen (zusätzlich BMW auf der Hebebühne und der Mercedes am Bildrand), im Rundgang eine (VW up!); Hero ohne lesbares Kennzeichen |
| **R18** | Video | **Drei Bereichsvideos** (Karosserie- und Mechanik-, Lackier-, Aufbereitungsbereich) für `/ueber-uns` und `/karriere`, je drei in einer Reihe im Kartenmuster | ~~André~~ User | — | ✅ **erledigt 2026-09-23** — der User hat drei Clips aus dem **schon gelieferten** Drohnenordner vom 07.09. zugeordnet (Hebebühne → Karosserie, Lackieren → Lack, Polieren → Aufbereitung); es fehlte also keine Lieferung, nur die Zuordnung. 2,88 MiB aus 62,5 MiB, 960 breit (Kartenbreite gemessen), stumm. **Zwei Kundenkennzeichen im Karosserieclip weichgezeichnet** (wie R16), Bild für Bild geprüft. B113–B118 sind am Ort geblieben. `docs/betriebsvideo/tasks/2026-09-23-bereichsvideos-tasks.md` |
| *(ohne Nr.)* | Bild / Recht | **Partnerlogos:** schriftliche Referenzfreigabe je Partner, monochrome Dateien, Vorgaben zu Mindestgröße und Schutzraum | André | ohne Freigabe dürfen die Logos nicht stehen | 🟨 **teilweise** — riparo (Logo + Link), Porsche Zentrum Leipzig (nur Link — die Wortmarke gehört der Porsche AG), BVAT-Siegel; 2026-09-16. Weitere Freigaben nach `docs/partnerlogos/README.md` · **2026-09-25:** dazu Volkswagen Automobile Leipzig und Audi Zentrum Leipzig, nur Link (5.16) |

**Bündelvorschlag:** Karriere (1.26 + R4) · Leistungstexte (R3) · Bilder (R7 + R2 + Partnerlogos) · Formularfelder (R12 + 1.18).

---

## 3. 🟢 Ohne Zulieferung umsetzbar (11)

| Nr. | Bereich | Aufgabe | Verantwortlich | Blocker | Status |
|---|---|---|---|---|---|
| **R9** | Formulare | **Anhänge mitsenden.** Derzeit ersetzt durch Vorgangsnummer + vorbereitete E-Mail | OALAB | **R10** — erst wenn der Versand läuft, ist absehbar, welcher Weg sich lohnt | 🟨 **für Schäden gelöst** — Fotos gehen seit 2026-09-16 über reparatur.info („Daten hochladen"). Offen nur noch für Termin-, Geschäftskunden- und Bewerbungsanfragen · Bewerbung → 5.29 (Anhang) |
...
| *(ohne Nr.)* | A11y | **Anhalte-Möglichkeit für die drei automatisch laufenden Videos** (WCAG 2.2.2: Bewegung über 5 s braucht Pause/Stopp). Seit der Korrektur vom 2026-09-07 laufen sie auch bei gemeldeter reduzierter Bewegung — dieses Flag war bisher die einzige Anhalte-Möglichkeit | OALAB | — | offen, aufgenommen 2026-09-10 (`docs/betriebsvideo/tasks/2026-09-07-betriebsvideo-tasks.md`, Phase 6) · *2026-09-17: Auch das animierte Logo läuft in Endlosschleife ohne Anhalten (Navigation, Zielgruppenkarten, Footer; dekorativ, `aria-hidden`) — beim Lösen mitentscheiden. Lösungsidee für die Filme: 4.14 als Klick-Video* · *2026-09-21: Die zwei neuen Videoarten sind davon ausgenommen — das Kartenvideo der Startseite (B11/B112) läuft nur in der aufgeklappten Karte und hält beim Kartenwechsel an; die Bereichsvideos (R18) spielen erst auf Klick* · 2026-09-25: 4.14 ist mit den Bereichsvideos erledigt (User); die Anhalte-Möglichkeit für die drei laufenden Videos bleibt offen |
| *(ohne Nr.)* | Bild | **Drohnen- und Rohclips** aus der Lieferung vom 2026-09-07 sind ungenutzt. Sie decken die offenen Fotopunkte **3.23–3.29** vermutlich teilweise ab — Einzelbilder daraus wären besser als gar kein Motiv | OALAB | — | 🟨 **teilweise** — am 2026-09-23 sind **3 der 12 Drohnenclips** als Bereichsvideos eingebaut (R18). Offen: die übrigen 9 Drohnenclips und 16 Rohclips. Der Polierclip zeigt Politur bei der Arbeit und trifft damit **3.23** inhaltlich; als Einzelbild noch nicht ausgewertet |
| **R17** | A11y / Messung | **Der Kontrastwächter kann Text am Verlaufsrand der Partnerliste melden.** Am 2026-09-21 meldete ein Lauf „Porsche Zentrum Leipzig“ mit 1,68:1 (mobil, Startseite); der Lauf danach — nach einer kleinen Layoutänderung in derselben Karte — meldete **0 von 5186** Stellen. Die Maske aus **R14** (`styles/scrollverlauf.css`) blendet die jeweils letzte Zeile aus, und welche Zeile das ist, hängt an der gemessenen Scrollposition. Der Befund ist damit **nicht stabil reproduzierbar** und kein Text ist dauerhaft unlesbar — er taucht aber wieder auf, sobald eine Messstelle auf den Verlaufsrand fällt. **Zu entscheiden:** Wächter um maskierte Bereiche schärfen ODER den Verlauf am unteren Rand kürzen | OALAB | — | offen, aufgenommen 2026-09-21 |
...
| **T4** | Verlinkung | **Zweiter Knopf auf den Aufbereitungskarten → Wissensbereich** | OALAB | — | offen · mit 5.17 mitentscheiden (fällt die Wissens-Karte weg?) |
| *(ohne Nr.)* | Paket B | **`ITEMS` gegen `serviceCatalog` prüfen**, ableiten oder bewusst trennen; Wächter erwägen | OALAB | — | offen |
| *(ohne Nr.)* | Design | **Footer-Icons stehen bei Kontrast 1,00:1** auf dunklem Grund | André *(Gestaltungsfrage)* | — | offen · mit 5.21 (Fußzeile verkleinern) mitentscheiden |
...
| Wartet auf André | **~~9~~ ~~10~~ ~~8~~ ~~10~~ ~~11~~ ~~10~~ ~~9~~ ~~8~~ 6** *(2026-09-25: − 1.18/2.26, in Schleife 5 aufgegangen (5.20); − R1, letztes Jahr geliefert (5.24). 2026-09-16: R13 erledigt, R12 ruht mit abgeschaltetem Schadenformular; Partnerlogos teilweise; R1 bis auf ein Jahr geliefert; Fotopunkte in Sichtung. 2026-09-18: + R15, R16 aus dem Bildinventar. 2026-09-21: + R18 Bereichsvideos, − R16 und R2 erledigt. 2026-09-23: − R18, vom User aus dem vorhandenen Drohnenmaterial zugeordnet)* |
...
| **Summe echt offen** | **~~22~~ ~~18~~ ~~20~~ ~~21~~ ~~19~~ ~~21~~ ~~22~~ ~~23~~ ~~22~~ ~~21~~ ~~20~~ 18** *(ohne Schleife 4 und 5 — die führen ihre 21 bzw. 44 Punkte selbst; 2026-09-25: − 1.18/2.26 (5.20), − R1 (5.24); 2026-09-18: + R15, R16; 2026-09-21: + R17, + R18, − R16, − R2; 2026-09-23: − R18)* |
