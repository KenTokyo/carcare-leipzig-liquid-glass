...
| 3.36 | **Reparaturseiten fuehrten auf das Aufbereitungsformular.** Behoben am 2026-09-05: Fünf Reparaturseiten öffnen jetzt das Schadenformular mit vorausgewählter Schadenart, Fuhrparkservice das Geschäftskundenformular. Das Schadenformular trägt beide Fälle — Unfall mit Versicherungsbezug und Reparatur ohne — über ein Gabelungsfeld statt über ein zweites Formular. Feldliste zum Streichen für André: `docs/formulare/schadenmeldung-felder-fuer-andre.md` (3.40). | **erledigt** |
