...
| 1.22 | Bewerbungsformular: Name, E-Mail, Telefon, Nachricht; Lebenslauf optional, Absenden auch ohne Anhang | Formular steht, **Versand eingerichtet (Netcup, R10), Live-Test ausstehend** |
...
| 1.18 | Aufbereitungsformular: neben Pflegepaketen auch „gewünschte Zusatzleistungen" auswählbar machen | **Struktur steht**, Liste offen (André) · *4.21 klärt die Formularseite: Auswahl „Gewünschte Leistung" = die Pakete* |
