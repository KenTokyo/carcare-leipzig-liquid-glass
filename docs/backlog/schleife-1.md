...
| Nr. | Aufgabe | Status |
|---|---|---|
| 1.17 | Aufbereitung → eigenes Formular, Anfrage direkt ins E-Mail-Postfach, auch mit Pop-up | **gebaut**, wartet auf Zugangsdaten (R10) |
